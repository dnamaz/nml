...
NML_CRYPTO = PROJECT_ROOT / "nml-crypto"
NML_BINARY = NML_CRYPTO if NML_CRYPTO.exists() else PROJECT_ROOT / "nml"
DASHBOARD_PATH = PROJECT_ROOT / "terminal" / "nml_collective_dashboard.html"
